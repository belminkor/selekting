            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table panel-border-color panel-border-color-primary">
                <div class="panel-heading">
                  Reference
                  <a href="dodaj-referencu.php">
                    <button type="button" class="btn btn-space btn-primary btn-sm pull-right"><i class="icon mdi mdi-plus"></i> Dodaj referencu</button>
                  </a>
                </div>
                <hr>
                <div class="panel-body">
                  ...
                  <table class="table table-striped table-borderless">
                    ...
                    <tbody class="no-border-x filtriraj">
                      <?php
                      $objekti = Select("reference", "", "ORDER BY postavljeno DESC", "");

                      foreach ($objekti as $objekat) {
                          echo '<tr>
                                  <td>'.$objekat['naziv'].'</td>                        
                                  <td class="actions"><a href="dodaj-referencu.php?edituj='.$objekat['id'].'" class="icon"><i class="mdi mdi-edit"></i></a></td>
                                  <td class="actions"><a href="reference.php?brisi='.$objekat['id'].'" class="icon"><i class="mdi mdi-delete"></i></a></td>
                                </tr>';
                      }
                       if(isset($_REQUEST['brisi'])){
                            ...
                            if($_REQUEST['brisi']!=""){
                              system('/bin/rm -rf ' . escapeshellarg("../Reference/$id"));
                            }
                            echo "<script>alert('Referenca je izbrisana!');window.location='reference.php';</script>";
                        }
                      ?>
                    </tbody>
                  </table>
