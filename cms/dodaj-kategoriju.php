...
$objekti = Select("kategorije", "WHERE id='$edituj'", "", "LIMIT 1");
...
<head>
    ...
    <title>CMS - Dodaj kategoriju</title>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                <div class="panel-heading panel-heading-divider">Dodaj kategoriju</div>
                <div class="panel-body">
                  <form method="POST" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Naziv kategorije</label>
                      <div class="col-sm-6">
                        <div class="input-group input-group-sm xs-mb-15"><span class="input-group-addon"><i class="icon mdi mdi-view-list"></i></span>
                          <input placeholder="Unesite naziv kategorije" class="form-control" type="text" value="<?php echo $naziv; ?>" required name="naziv">
                        </div>
                      </div>
                    </div>
                    <hr>
                  ...
                  if(isset($_REQUEST['naziv'])){
                    ...
                    if(!isset($_REQUEST['edituj'])){
                      $id = Insert("kategorije", "naziv", "'$naziv'");

                      echo "<script>alert('Kategorija je dodana!');window.location='kategorije.php';</script>";
                    }else{
                      $id = $conn->real_escape_string($_REQUEST['edituj']);
                      Update("kategorije", "naziv='$naziv'",  $id);

                      echo "<script>alert('Promjene su spašene!');window.location='kategorije.php';</script>";
