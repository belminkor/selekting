            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table panel-border-color panel-border-color-primary">
                <div class="panel-heading">
                  Kategorije
                  <a href="dodaj-kategoriju.php">
                    <button type="button" class="btn btn-space btn-primary btn-sm pull-right"><i class="icon mdi mdi-plus"></i> Dodaj kategoriju</button>
                  </a>
                </div>
                <hr>
                  ...
                  <table class="table table-striped table-borderless">
                    ...
                    <tbody class="no-border-x filtriraj">
                      ...
                      foreach ($objekti as $objekat) {
                          echo '<tr>
                                  <td>'.$objekat['naziv'].'</td>                        
                                  <td class="actions"><a href="dodaj-kategoriju.php?edituj='.$objekat['id'].'" class="icon"><i class="mdi mdi-edit"></i></a></td>
                                  <td class="actions"><a href="kategorije.php?brisi='.$objekat['id'].'" class="icon"><i class="mdi mdi-delete"></i></a></td>
                                </tr>';
                      }
                       if(isset($_REQUEST['brisi'])){
                            $id = $_REQUEST['brisi'];
                            Remove("kategorije", $id);

                            echo "<script>alert('Kategorija je izbrisana!');window.location='kategorije.php';</script>";
                        }
                      ?>
                    </tbody>
                  </table>
