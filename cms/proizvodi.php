            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table panel-border-color panel-border-color-primary">
                <div class="panel-heading">
                  Proizvodi
                  <a href="dodaj-proizvod.php">
                    <button type="button" class="btn btn-space btn-primary btn-sm pull-right"><i class="icon mdi mdi-plus"></i> Dodaj proizvod</button>
                  </a>
                </div>
                <hr>
                <div class="panel-body">
                  ...
                  <table class="table table-striped table-borderless">
                    ...
                    <tbody class="no-border-x filtriraj">
                      <?php
                      $objekti = Select("proizvodi", "", "ORDER BY postavljeno DESC", "");

                      foreach ($objekti as $objekat) {
                          if($objekat['vidljiv']=="on"){
                            $vidljiv = "Da";
                          }else{
                            $vidljiv = "Ne";
                          }
                            echo '<tr>
                                  <td>'.$objekat['naziv'].'</td>
                                  <td>'.$vidljiv.'</td>
                                  <td class="actions"><a href="dodaj-proizvod.php?edituj='.$objekat['id'].'" class="icon"><i class="mdi mdi-edit"></i></a></td>
                                  <td class="actions"><a href="proizvodi.php?brisi='.$objekat['id'].'" class="icon"><i class="mdi mdi-delete"></i></a></td>
                                </tr>';
                      }
                       if(isset($_REQUEST['brisi'])){
                            ...
                            if($_REQUEST['brisi']!=""){
                              system('/bin/rm -rf ' . escapeshellarg("../Proizvodi/$id"));
                            }
                            echo "<script>alert('Proizvod je izbrisan!');window.location='proizvodi.php';</script>";
                        }
                      ?>
                    </tbody>
                  </table>
