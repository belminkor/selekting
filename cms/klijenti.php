            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table panel-border-color panel-border-color-primary">
                <div class="panel-heading">
                  Klijenti
                  <a href="dodaj-klijenta.php">
                    <button type="button" class="btn btn-space btn-primary btn-sm pull-right"><i class="icon mdi mdi-plus"></i> Dodaj klijenta</button>
                  </a>
                </div>
                <hr>
                <div class="panel-body">
                  ...
                  <table class="table table-striped table-borderless">
                    ...
                    <tbody class="no-border-x filtriraj">
                      <?php
                      $objekti = Select("klijenti", "", "ORDER BY postavljeno DESC", "");

                      foreach ($objekti as $objekat) {
                          echo '<tr>
                                  <td>'.$objekat['kompanija'].'</td>                        
                                  <td class="actions"><a href="dodaj-klijenta.php?edituj='.$objekat['id'].'" class="icon"><i class="mdi mdi-edit"></i></a></td>
                                  <td class="actions"><a href="klijenti.php?brisi='.$objekat['id'].'" class="icon"><i class="mdi mdi-delete"></i></a></td>
                                </tr>';
                      }
                       if(isset($_REQUEST['brisi'])){
                            $id = $_REQUEST['brisi'];

                            echo "<script>alert('Klijent je izbrisan!');window.location='klijenti.php';</script>";
                        }
                      ?>
                    </tbody>
                  </table>
