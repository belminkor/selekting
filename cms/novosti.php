            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table panel-border-color panel-border-color-primary">
                <div class="panel-heading">
                  Aktuelnosti
                  <a href="dodaj-novost.php">
                    <button type="button" class="btn btn-space btn-primary btn-sm pull-right"><i class="icon mdi mdi-plus"></i> Dodaj aktuelnost</button>
                  </a>
                </div>
                <hr>
                  ...
                  <table class="table table-striped table-borderless">
                    ...
                    <tbody class="no-border-x filtriraj">
                      ...
                      foreach ($objekti as $objekat) {
                          echo '<tr>
                                  <td>'.$objekat['naslov'].'</td>                        
                                  <td class="actions"><a href="dodaj-novost.php?edituj='.$objekat['id'].'" class="icon"><i class="mdi mdi-edit"></i></a></td>
                                  <td class="actions"><a href="novosti.php?brisi='.$objekat['id'].'" class="icon"><i class="mdi mdi-delete"></i></a></td>
                                </tr>';
                      }
                       if(isset($_REQUEST['brisi'])){
                            ...
                            if($_REQUEST['brisi']!=""){
                              system('/bin/rm -rf ' . escapeshellarg("../Novosti/$id"));
                            }
                            echo "<script>alert('Aktuelnost je izbrisana!');window.location='novosti.php';</script>";
                        }
                      ?>
                    </tbody>
                  </table>
