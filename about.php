                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="breadcrumbs-inner">
                                <h1 class="breadcrumbs-title">O nama</h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title text-left ">
                                <h2 class="uppercase"><?php echo $naslov; ?></h2>
                                <h6 class="mb-40"><?php echo $podnaslov; ?></h6>
                            </div>
                        </div>
                    </div>                    
                    <div class="row">
